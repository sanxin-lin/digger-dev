import { defineConfig } from './digger.config.js';
...
const description = {
  'zh-CN':
    'Digger 是一个基于 Vue3 开发的 Material 风格移动端组件库，全面拥抱 Vue3 生态，由社区团队维护。支持 Typescript、按需引入、暗黑模式、主题定制、国际化，并提供 VSCode 插件保障良好的开发体验。',
  'en-US':
    'Digger is a Material design mobile component library developed based on Vue3, developed and maintained by partners in the community. Support Typescript, import on demand, dark mode, theme customization, internationalization, and provide VSCode plugin to ensure a good development experience.',
};

const keywords = {
  'zh-CN': 'Digger,Vue3 移动端组件库,Material Design',
  'en-US': 'Digger,Vue3 Mobile Components Library,Material Design',
};
...
export default defineConfig({
  ...
  port: 8080,
  title: 'DIGGER',
  logo: 'https://digger.gitee.io/digger-ui/digger_icon.png',
  ...
  pc: {
    ...
    indexPage: {
      ...
      features: [
        ...
        },
        {
          ...
          description: {
            ...
            'en-US':
              'Each component can be imported separately and has good tree-shaking optimization',
          },
        },
        {
          name: {
        ...
        },
        {
          ...
          description: {
            ...
            'en-US':
              'Built-in i18n API, which supports both Chinese and English languages by default',
          },
        },
        {
          name: {
      ...
      contributors: {
        ...
        link: 'https://github.com/diggerjs/digger/graphs/contributors',
        image: 'https://contrib.rocks/image?repo=diggerjs/digger',
      },
      sponsors: {
        label: {
          'zh-CN': '赞助者',
        ...
        link: 'https://cdn.jsdelivr.net/gh/diggerjs/digger-static/sponsorkit/sponsors.svg',
        image: 'https://cdn.jsdelivr.net/gh/diggerjs/digger-static/sponsorkit/sponsors.svg',
      },
      license: {
      ...
      copyright: {
        'zh-CN': 'Copyright © 2022 diggerjs 组织成员以及 digger 的贡献者们',
        'en-US': 'Copyright © 2022 diggerjs member and digger contributors.',
      },
    },
    header: {
      i18n: {
      ...
      versions: null,
      github: 'https://github.com/diggerjs/digger',
      playground: 'https://digger.gitee.io/digger-ui-playground',
      darkMode: true,
    },
    clipboard: {
      'zh-CN': '代码已复制到剪切板',
