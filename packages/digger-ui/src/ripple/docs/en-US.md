...
```html
<template>
  <div class="ripple-example-block dig-elevation--2" v-ripple>click</div>
</template>
...
```html
<template>
  <div class="ripple-example-block dig-elevation--2" v-ripple="{ color: '#2979ff' }">
    click
  </div>
</template>
...
```html
<template>
  <div class="ripple-example-block dig-elevation--2" v-ripple="{ disabled: true }">
    click
  </div>
</template>
